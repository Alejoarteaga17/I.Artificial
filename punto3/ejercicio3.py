...
print("Camino usado en BFS:", bfs_result.path() if bfs_result else "No se encontró un camino")
...
print(f"Tiempo ejecutando IDS: {ids_time:.6f}s, Uso de memoria: {ids_memory[1] / 1024:.2f} KB")